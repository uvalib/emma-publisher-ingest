...
OA_RETRIEVALS = int(os.environ.get('OA_RETRIEVALS', 100))
...
DATE_LOWER_BOUNDARY_DATE_FIELD = 'from_created_date'
DATE_LOWER_BOUNDARY_FIELD = 'from_updated_date'
DATE_UPPER_BOUNDARY_FIELD = 'to_updated_date'
